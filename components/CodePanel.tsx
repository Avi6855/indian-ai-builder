...
root.render(<React.StrictMode><App /></React.StrictMode>);`
      ...
      zip.file(
        "README.md",
        `# INDIAN AI BUILDER\n\nGenerated with [INDIAN AI BUILDER](https://indianaibuilder.com).\n\n## Getting started\n\n\`\`\`bash\nnpm install\nnpm start\n\`\`\``
      );
        ...
        {(isGenerating || isImproving) && (
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-6 bg-[#0a0a0a]/85 backdrop-blur-sm">
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              <p className="text-xs text-white/40 mt-1 text-center max-w-[250px]">
                This usually takes 1-2 minute's. It's complete free version and there are so many requests are in queue. Sometimes, it takes more time.
              </p>
            </div>
          </div>
        )}
