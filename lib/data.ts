...
export const SUGGESTIONS = [
  "A student grade tracker with charts",
  "A GST invoice generator for Indian businesses",
  "A cricket scorecard app with live updates",
  "A UPI payment dashboard with analytics",
  "A Hindi-English dictionary app",
  "A crop yield calculator for farmers",
];
...
export const FEATURES = [
  {
    ...
    desc: "Describe your app in plain English. INDIAN AI BUILDER returns production-ready React + Tailwind code in seconds.",
  },
  {
    icon: Eye,
    label: "Live preview",
...
export const STEPS = [
  ...
  },
  {
    ...
    desc: "INDIAN AI BUILDER writes React + Tailwind components, picks dependencies, and structures your files.",
  },
  {
    number: "03",
